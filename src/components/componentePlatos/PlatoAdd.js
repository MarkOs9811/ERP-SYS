...
import { validatePrecio,handlePrecioInput, validateTelefono  } from "../../hooks/InputHandlers";
...
export function PlatoAdd({handleCloseModal}){
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const response = await axiosInstance.post('/gestionPlatos/addPlatos', formDataToSend);
    ...
    return(
        <div>
            <form onSubmit={handleSubmit(onSubmit)}>
                {/* Foto de perfil */}
                <div className="mb-3">
                    <label htmlFor="foto" className="form-label">Imagen Plato</label>
                    <div
                    {...getRootProps()}
                ...
                <div className="row">
                    ...
                    <div className="col-6">
                        <div className="form-floating mb-3">
                            ...
                            className={`form-control ${errors.nombre ? "is-invalid" : ""}`} placeholder=" "
                            {...register('nombre',{
