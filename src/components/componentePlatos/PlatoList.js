import { faPlus, faPowerOff, faTrashCan } from "@fortawesome/free-solid-svg-icons";
                    ...
                    <div className="d-flex justify-content-around">
                        {estado === 1 ? (
                            <>
                                ...
                                <button className="btn-eliminar" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar Plato">
                                    <FontAwesomeIcon icon={faTrashCan} />
                                </button>
                            </>
                        ):(
                            <button className="btn btn-outline-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Activar Plato">
        ...
        <div>
           <DataTable
            ...
            />
             ...
             <Modal show={showModalEditar} onHide={handleCloseEditarCat} centered className="modal-sin-borde">
                <Modal.Header closeButton>
                <Modal.Title>Actualizar Plato</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                {/* Pasa handleCloseModal como prop a CATEGORIA */}
                    <PlatoEditar handleCloseModal={handleCloseEditarCat} dataPlato={dataPlato}  />
                </Modal.Body>
            </Modal>
